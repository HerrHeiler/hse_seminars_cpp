...
### Transaction
* id: string — [UUID](https://en.wikipedia.org/wiki/Universally_unique_identifier) transaction id
...
You have `bank_account.h` header file with needed structures and functions.
