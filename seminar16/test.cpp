...
protected:
    ...
    double hoursWorked;
public:
    HourlyEmployee(const std::string _name, int _id, double _month_salary, double _hourly_rate, double _hours_worked) : Employee(_name, _id), hourlyRate(_hourly_rate), hoursWorked(_hours_worked) {};
    //ovirriding
    double calculatePay() const override {
...
int main() {
    ...
    SalariedEmployee se = new SalariedEmployee("name", )
    return 0;
}